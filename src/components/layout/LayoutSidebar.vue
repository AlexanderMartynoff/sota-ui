<template>
  <div class="x-layout__sidebar border-r-1 border-r-gray-200 hidden" :class="[{'@2xl:block': visible}, classes]" :data-view="view" v-if="slots.default">
    <slot/>
  </div>
</template>
...
const layout = inject<{onSidebarVisibilityChange: (visibility: boolean) => void}>('layout')
